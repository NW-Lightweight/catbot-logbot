...
function composeMessage(data) {
	...
	const wordToReplace = ['discord.com/invite', 'youtube.com/@', 't.me/', 'twitter.com', 'discord.gg/', 'dsc.gg/', 'youtube.com/channel', 'https://', '`', '*', '_', '~'];
...
client.on('ready', () => {
	client.user.setActivity('tf2 relay', { type: "PLAYING" });
